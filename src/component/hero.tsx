    ...
    <div>
      <div className="relative flex w-full flex-col items-center justify-start px-4 pt-32 sm:px-6 sm:pt-24 md:pt-32 lg:px-8">
        <div className="flex w-full max-w-6xl flex-col space-y-4 overflow-hidden pt-8">
          <h1 className="text-center text-5xl font-medium leading-tight text-foreground sm:text-7xl md:text-8xl mt-[-10px]">
            <span className="inline-block px-1 md:px-2 text-balance">
